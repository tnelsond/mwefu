...
\documentclass[openany, twoside, 14pt, extrafontsizes]{memoir}
\usepackage{footnotebackref}
\usepackage[paperwidth=6in,paperheight=9in,margin=.6in,bmargin=1in, twoside, bindingoffset=.7in]{geometry}
\usepackage{graphicx}
